		...
		for (var n=0; n<nuclei.length; n++) {
			...
			for (var l=0; l<library.length; l++) {
				...
				if ( sequence[i-1] == library[l].residue && nuclei[n] == library[l].nucleus ) {
					...
					cs += library[l].previous;

				}

				else if ( sequence[i] == library[l].residue && nuclei[n] == library[l].nucleus ) {

					cs += library[l].current;

				}

				else if ( sequence[i+1] == library[l].residue && nuclei[n] == library[l].nucleus ) {
